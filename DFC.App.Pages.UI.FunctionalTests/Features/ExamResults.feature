...
Scenario: Navigate to A-Level page
	...
	Then I am taken to the Options after A level, vocational, technical or other level 3 results page

@Pages @ExamResults
Scenario: Navigate to GCSE page
	Given I am on the exam results page
	When I click the Options after GCSE, vocational, technical or other level 2 results link
	Then I am taken to the Options after GCSE, vocational, technical or other level 2 results page
