...
namespace DFC.App.Pages.Services.CacheContentService.UnitTests.WebhooksServiceTests
{
    ...
    public class WebhooksServiceProcessContentItemAsyncTests : BaseWebhooksServiceTests
    {
        ...
        public async Task WebhooksServiceProcessContentItemAsyncForCreateReturnsSuccess()
        {
            ...
            A.CallTo(() => FakeCmsApiService.GetContentItemAsync<CmsApiHtmlModel>(A<Uri>.Ignored)).Returns(expectedValidPagesApiContentItemModel);
            A.CallTo(() => FakeContentPageService.GetByIdAsync(A<Guid>.Ignored, A<string>.Ignored)).Returns(expectedValidContentPageModel);
            A.CallTo(() => FakeMapper.Map(A<CmsApiHtmlModel>.Ignored, A<ContentItemModel>.Ignored)).Returns(expectedValidContentItemModel);
            ...
            A.CallTo(() => FakeMapper.Map(A<CmsApiHtmlModel>.Ignored, A<ContentItemModel>.Ignored)).MustHaveHappenedOnceOrMore();
